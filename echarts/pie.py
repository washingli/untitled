...
aim_dict = {}
aim_dict['Data'] = data2
print(type(aim_dict['Data']))
aim_dict['链接'] = 'http://echarts.baidu.com/demo.html#pie-simple'
print(aim_dict)

csv_file = pd.DataFrame(aim_dict)
print(csv_file)
csv_file.to_csv("H:\工作\工作-沪东重机\图表展示\pie.csv")

csv_file2 = pd.read_csv("H:\工作\工作-沪东重机\图表展示\pie.csv",encoding='gbk')
print(csv_file2)

json_file = csv_file2.to_json()
print(json_file)

# api = To_Hbase()
# api.json_to_hbase(aim_dict,'pie')